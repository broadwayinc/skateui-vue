...
div
    ...
    div
        ...
        sui-card(:style="{marginRight: '1rem'}")
            ...
            template(#buttonFooter) BUTTON
            template(#footer) FOOTER
        sui-card(content-center :style="{marginRight: '1rem'}" :close="()=>{console.log('closed')}")
    ...
    br
    br
    sui-card(content-center sticky-mobile-button)
        template(#title)
            h6 Button
        template(#content)
            h4 Look! A Button!
        ...
        template(#content)
            ...
            div(style="display: flex;justify-content: space-between;")
                sui-tooltip.
                    This is a tooltip.
                    direction is auto.
                sui-tooltip(direction="top-left").
                    This is a tooltip.
    ...
    sui-card
        ...
        template(#content)
            ...
            br
            sui-steps(type="ring" :steps="['Skate', 'Learn to code', { text:'Become a computer nerd', icon: 'accessibility_new' }, 'Get a dog']" :completed=2)
            br
            br
            p.
    ...
    sui-card(content-center :style="{width: '600px'}")
        ...
        template(#content)
            sui-image(
                ...
                :ratio='[16,9]'
                parallax
                error-img="/img/bunnykit_small.gif")
            br
            sui-image(
                src="/img/dia.png"
                light-box
    ...
    sui-card
        template(#title)
            h6 Option
        template(#content)
            sui-option(type="checkbox" label="checkbox" value="Checkbox1" name="checkbox1")
            br
            sui-option(type="checkbox" label="checkbox" value="Checkbox2" name="checkbox2" disabled)
            br
            sui-option(type="radio" name="radio" label="Radio 1" value="1" checked)
            br
            sui-option(type="radio" name="radio" label="Radio 2" value="2" disabled)
            br
            sui-option(type="radio" name="radio" label="Radio 3" value="3" )
    br
    br
    sui-card(:close="()=>{console.log('close')}")
        template(#title)
            h6 Image Editor
        template(#image)
            img(src="/img/myface.jpg")
    ...
    sui-card(:close="()=>{console.log('close')}")
        ...
        template(#content)
            .cart
                ...
                br
                small(style="color:var(--button-nude);font-weight:bold") 53 left
                br
                .price $ 1,000,000
                br
                br
    ...
    br
    br
    sui-card(:style="{backgroundColor: 'var(--analogous)', color:'var(--analogous-text'}")
    ...
    data() {
        return {
            ...
            list: [
                ...
                {
                    image: '/img/nike1.jpg',
                    title: 'Nike shoes, 2021 Model',
                    price: '$199.99'
                },
                {
                    image: '/img/newyork.jpg',
                    title: 'Full New york zombie tour',
                    price: '$399.99'
                },
                {
                    image: '/img/bunnykit.jpg',
                    title: 'Peach blouse',
                    price: '$99.99'
                },
                {
